...
// Legacy Blackbox API errors (for backward compatibility)
  ...
  // Gemini API errors
  missing_gemini_api_key: { status: 500, code: "missing_gemini_api_key", message: "Assistant configuration is incomplete." },
  // Provider errors (shared by all AI providers)
  provider_auth_error: { status: 502, code: "provider_auth_error", message: "AI provider authentication failed." },
  provider_rate_limited: { status: 503, code: "provider_rate_limited", message: "AI is busy, please try again in a few seconds. ✈️" },
  provider_unavailable: { status: 503, code: "provider_unavailable", message: "AI service is temporarily unavailable. Please try again shortly." },
  ...
  provider_budget_exceeded: { status: 502, code: "provider_budget_exceeded", message: "AI API Budget has been exceeded. Please check your Blackbox account billing." },
