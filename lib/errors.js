const ERROR_CATALOG = {
  ...
  non_domain_request: { status: 400, code: "non_domain_request", message: "I am the Algore Charter Travels assistant and can only help with travel, visa, booking, and recruitment services." },
